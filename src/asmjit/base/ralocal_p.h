...
public:
  ...
  ASMJIT_INLINE PhysToWorkMap* getPhysToWorkMap() const noexcept { return _curAssignment.getPhysToWorkMap(); }
  ASMJIT_INLINE WorkToPhysMap* getWorkToPhysMap() const noexcept { return _curAssignment.getWorkToPhysMap(); }
