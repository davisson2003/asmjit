...
static ASMJIT_FORCEINLINE ConstPool::Node* ConstPoolTree_skewNode(ConstPool::Node* node) noexcept {
...
static ASMJIT_FORCEINLINE ConstPool::Node* ConstPoolTree_splitNode(ConstPool::Node* node) noexcept {
